...
type ResizeHandleProps = React.ComponentProps<typeof ResizablePrimitive.PanelResizeHandle> & {
  withHandle?: boolean;
};
...
const ResizableHandle = ({ withHandle, className, ...props }: ResizeHandleProps) => (
